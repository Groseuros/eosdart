...
// var ripemd160 = require('./ripemd').RIPEMD160.hash as (a: Uint8List) => ArrayBuffer;
...
/// If a key is in the legacy format (`EOS` prefix), then convert it to the new format (`PUB_K1_`).
/// Leaves other formats untouched
List<String> convertLegacyPublicKeys(List<String> keys) => keys.map((item)=>convertLegacyPublicKey(item)).toList();
